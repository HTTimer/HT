...
var goals = (function() {
	...
	function init() {
		...
		if (typeof core.get("goals") === "undefined")
			core.set("goals", [
				[]
			]); //[Sessions[Goals[Average of x, Goalfor Average of x, Date, disabled]]]
	 ...
	 */
	function addGoal() {
		core.get("goals")[core.get("config").currentSession].push([prompt("Aox. x=?"), prompt("Goal in s") * 1000, +Infinity, false]);
		display();
	}
