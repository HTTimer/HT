...
/* mousetrap v1.6.0 craig.is/killing/mice , speed-optimized by me and formatted by my editor, not changing the way it works */
(function(r, t, g) {
	function u(a, b, h) {
		a.addEventListener ? a.addEventListener(b, h, false) : a.attachEvent("on" + b, h)
	}
	...
	function C(a, b) {
		return null === a || a === t ? false : a === b ? !0 : C(a.parentNode, b)
	}
	...
	function c(a) {
		...
		function e(a) {
			...
			var b = y(a);
			b && ("keyup" == a.type && x === b ? x = false : d.handleKey(b, D(a), a))
		}
		...
		d._handleKey = function(a,
			...
			for (d = 0; d < f.length; ++d) f[d].seq ? f[d].level == k && (l = true, c[f[d].seq] = 1, g(f[d].callback, e, f[d].combo, f[d].seq)) : l || g(f[d].callback, e, f[d].combo);
			f = "keypress" == e.type && p;
			e.type != w || v(a) || f || b(c);
			p = l && "keydown" == e.type
		};
	...
	if (r) {
		...
		c.prototype.stopCallback = function(a, b) {
			return -1 < (" " + b.className + " ").indexOf(" mousetrap ") || C(b, this.target) ? false : "INPUT" == b.tagName || "SELECT" == b.tagName || "TEXTAREA" == b.tagName || b.isContentEditable
		};
