<div class="container">
  ...
  <?php
    ...
    function hinzufuegen($name,$inhalt,$author,$tags,$id){
      echo '<li class="list-group-item">
        <div class="row">
          <div class="col-md-7">
            <h4><a href="index.php?show=Documents/documents_view&id='.$id.'">'.$name.'</a> ';
      ...
      echo '</h4>
          ...
          <div class="col-md-5">
            ...
            <a href="includes/Documents/documents_download.php?id='.$id.'"><span class="glyphicon glyphicon-save-file"></span></a>
            <br/><br/>
  ...
  <a href="index.php?show=Documents/documents_add" class="btn btn-success">Add</a><br/><br/>
</div>
